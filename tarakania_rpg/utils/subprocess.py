...
async def create_subprocess_exec(
    *args: str, stdout: Optional[IO[AnyStr]] = None, stderr: Optional[IO[AnyStr]] = None
) -> subprocess.Process:
    return await subprocess.create_subprocess_exec(
        *args, stdout=stdout or subprocess.PIPE, stderr=stderr or subprocess.PIPE
    )
...
async def create_subprocess_shell(
    ...
    return await subprocess.create_subprocess_shell(
        program, stdout=stdout or subprocess.PIPE, stderr=stderr or subprocess.PIPE
    )


async def run_subprocess_exec(*args: str, **kwargs: Any) -> Tuple[bytes, bytes]:
...
async def run_subprocess_shell(program: str, **kwargs: Any) -> Tuple[bytes, bytes]:
